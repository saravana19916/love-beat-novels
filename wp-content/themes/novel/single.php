...
<!-- <div class="container mt-5"> -->
                        ...
                        <div class="shadow-lg rounded mt-4 shadow-div">
                            <div class="d-flex justify-content-between align-items-center px-4 pt-4">
                                <h6 class="mb-0 fw-bold">
                                    ...
                                    <?php
                                        $is_locked = find_episode_is_locked($parentId, $episode_id, $episodeNumber);
                                    ?>
    ...
    ?>
            ...
            <div class="container details-page mt-5">
                <?php
                    $parentId = get_post_meta(get_the_ID(), 'parent_blog_id', true) 
                                ?: get_post_meta(get_the_ID(), 'my_creation_parent_blog_id', true);
                    $episodeNumber = get_post_meta(get_the_ID(), 'episode_number', true);
                    $is_locked = false;
